...
|---|---|
| Belge sürümü | `0.11.2` |
| Durum | `PHASE_2_ACTIVE — PH2_T02_R3_RIGHTS_DISCOVERY_RUNNING` |
| Onay tarihi | `2026-08-13` |
| Belge sahibi | Proje sahibi |
| Uygulama ortamı | Codex in ChatGPT Work |
| Aktif görev | `PH2-T02-R3` — resmî Data.gov raw metadata haklar zinciri Discovery |
...
- Aktif görev: `PH2-T02-R3`; aynı resmî hostlarda exact raw metadata Discovery yürütülüyor
...
- Sıradaki kapı: BTS flight metadata → TranStats distribution → government-works lisans zinciri

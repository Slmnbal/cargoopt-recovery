...
|---|---|
| Belge sürümü | `0.11.4` |
| Durum | `PHASE_2_ACTIVE — PH2_T02_R3_RESULT_READY_FOR_EXTRACT_PLANNING_DECISION` |
| Onay tarihi | `2026-08-13` |
| Belge sahibi | Proje sahibi |
| Uygulama ortamı | Codex in ChatGPT Work |
| Aktif görev | Yok — form ve haklar Discovery kapıları geçti |
...
- Sıradaki kapı: January 2024 exact-15 header-only bounded Extract güvenlik görevi
